/*
# PROGRAM : PROGRAM FOR REFLECTION AND SHEAR
# NAME : SHARVARI  S. WAGH
# SE-(A) ROLL NO : 73
#----------------------------------------------------------
Write a C++ program to implement shear and reflection of 2D object about X-axis,Y-axis about line
...
void ref_org(int n,float c[][3])	//reflection about y=x line
{
	float b[10][3],a[10][3];
